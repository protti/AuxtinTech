...
public class Choose {
	...
	public ArrayList<MotherBoard> chooseMotherBoard(Configuration conf) throws SQLException
	{
	...
	public ArrayList<Case> chooseCase(Configuration conf) throws SQLException
	{
	...
	public ArrayList<HddSsd> chooseDisk(Configuration conf) throws SQLException
	{
	...
	public ArrayList<Heatsink> chooseHeatsink(Configuration conf) throws SQLException
	{
	...
	public ArrayList<PowerPack> choosePowerPack(Configuration conf) throws SQLException
	{
	...
	public ArrayList<Processor> chooseProcessor(Configuration conf) throws SQLException
	{
	...
	public ArrayList<Ram> chooseRam(Configuration conf) throws SQLException
	{
	...
	public ArrayList<VideoCard> chooseVideoCard(Configuration conf) throws SQLException
	{
